...
### Chores
- **deps:** Adopt dig-rpc-protocol 0.12 + dig-peer 0.15 (#53)

## [0.23.0] - 2026-09-09

### Chores
- **deps:** Bump dig-rpc-protocol to 0.11, dig-peer to 0.14 (#52)
...
### Build
- **deps:** Uplift dig-dht 0.13 -> 0.15 (#47)
...
### Bug Fixes
- **module:** Bound the getModuleInfo ask, and make the shape guard falsifiable (#44)
...
### Bug Fixes
- **module:** Preserve staged bytes across a descriptor demotion and budget transport failures (#40)
...
### Chores
- **deps:** Adopt dig-rpc-protocol 0.10 (#34)
...
### Chores
- **plan:** Re-export MAX_RESOURCE_CHUNK_COUNT from dig_nat instead of redefining

## [0.17.0] - 2026-08-06

### Features
- **source:** Reassemble the dig-nat paged prologue so large resources are readable (#1668)

## [0.16.0] - 2026-08-06

### Bug Fixes
- **read-ladder:** Local rungs must target dig-node's real listeners, not https://host:port (#2164)

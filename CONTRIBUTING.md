...
- Include crate version (`Cargo.toml` `version`, or `cargo tree -p dig-download`) and
...
- `Format / Clippy / Test / Docs`
- `Coverage (>=80% lines)`
- `Cargo.lock own-version matches Cargo.toml`
